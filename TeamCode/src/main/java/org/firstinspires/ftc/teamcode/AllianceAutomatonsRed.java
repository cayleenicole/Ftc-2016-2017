 ...
 */
@Disabled
@Autonomous(name = "AllianceAutomatonsRed", group = "Cayles")
public class AllianceAutomatonsRed extends LinearOpMode {
    ...
    private void beaconSwitchCase(){
        ...
        switch(value){
            ...
            case 5: encoderDrive(DRIVE_SPEED,  20.00,  -20.00, 1.5, headingEncoder);
                break;
            case 6: gyroRotate(-0.5, 235);
                break;
            case 7: moveToWall(0.5);
                break;
            case 18: strafeToLine(0.5,currentTime);
                break;
            case 19: currentTime = getRuntime();while(getRuntime() - currentTime < 2.0 && opModeIsActive())strafe(0.5, "right");value++;
                break;
            case 20: moveToWall(0.5);
                break;
            case 110: strafeToLine(0.5,currentTime);
                break;
            case 8: currentTime = getRuntime();while(getRuntime() - currentTime < 5.0 && opModeIsActive())strafe(0.5, "left");value++;
                break;
            case 133: moveToWall(0.5);
                break;
            case 9: currentTime = getRuntime();while(getRuntime()-currentTime < 3.0 && opModeIsActive()){robotDrive(-0.3, 0.3);}robotStop();value++;
                break;
            case 10: gyroRotate(-0.5, 240);
                break;
            case 11: currentTime = getRuntime();while(getRuntime()-currentTime < 3.5 && opModeIsActive()){robotDrive(1.0, -1.0);}robotStop();value++;
                break;
