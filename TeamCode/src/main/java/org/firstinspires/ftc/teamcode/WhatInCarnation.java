...
/**
 * Created by cicada02 on 2/23/17.
 */
...
public class WhatInCarnation extends LinearOpMode{
    ...
    private void beaconSwitchCase(){
        ...
        switch(value){
            ...
            case 7: moveToWall(0.5);
                break;
            case 8: strafeToBeacon(1.0);
                break;
            case 9: checkBeaconColor(0.5,currentTime);
                break;
            ...
            case 11: moveToWall(0.5);
                break;
            case 12: strafeToBeacon(1.0);
                break;
            case 13: checkBeaconColor(0.5,currentTime);
                break;
            ...
            case 17: gyroRotate(-0.5, 240);
                break;
            case 19: currentTime = getRuntime();while(getRuntime()-currentTime < 3.5 && opModeIsActive()){robotDrive(1.0, -1.0);}robotStop();value++;
                break;
    ...
    private void checkBeaconColor(double speed, double time){
    ...
    public void strafeToBeacon(double driveSpeed){

        while(odsSensor.getRawLightDetected() < opticalDistance){

            strafe(driveSpeed, "right");
            debug();
